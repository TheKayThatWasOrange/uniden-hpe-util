...
You might be tempted to think that you can just clone an existing channel over and over and then type in the new frequencies to speed through all that data entry tedium the way you might in an actual spreadsheet, but you'd be living in some kind of Bizarro world where Uniden hires competent product managers. Sentinel is here to guard you from socialist constructs like convenience and ease of use. What are you? Some kind of ANTIFA snowflake?
